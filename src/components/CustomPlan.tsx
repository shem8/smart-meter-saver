...
const CustomPlan = ({ onPlanSelect }: CustomPlanProps) => {
  ...
  const addTimeSlot = () => {
    if (!newSlot.name || !newSlot.discount || !newSlot.startHour || !newSlot.endHour) {
      return;
    }
    ...
    setNewSlot({ name: "", discount: "", startHour: "", endHour: "", days: [] });
  };
  ...
  const formatDays = (days: string[]) => {
    ...
    return days.map(d => daysOfWeek.find(day => day.id === d)?.label).join(", ");
  };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="p-6 mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-foreground">הוסף מסלול הנחה</h3>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewSlot({ ...newSlot, discount: e.target.value })}
                  />
                </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-4 gap-2 mb-4">
                  {daysOfWeek.map((day) => (
                    <Button
                      key={day.id}
                      variant={newSlot.days.includes(day.id) ? "default" : "outline"}
                      size="sm"
                ...
                <Button 
                  onClick={addTimeSlot}
                  className="w-full"
                  disabled={!newSlot.name || !newSlot.discount || !newSlot.startHour || !newSlot.endHour}
                >
            ...
            <Card className="p-6 mb-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">המסלולים שלך</h3>
                </div>
